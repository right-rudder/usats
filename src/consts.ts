...
export const SITE_DESCRIPTION =
  "Launch your aviation career with USATS in Titusville, FL. Offering FAA-certified helicopter and airplane training, modern fleet, international student support, and Part 141 programs. Trusted by pilots from 120+ countries since 1993.";
...
export const OG_IMAGE = "/usats_logo_white-USATS-florida-aviation-academy-florida.webp";
...
export const FLIGHT_TRAINING_TYPES = [
...
// Schema.org related constants
export const FOUNDING_DATE = "1993";
export const PRICE_RANGE = "$$$";
export const PAYMENT_ACCEPTED =
  "Cash, Credit Card, Visa, Mastercard, American Express, Discover, Checks, Financing";
