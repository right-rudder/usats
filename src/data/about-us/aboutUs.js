...
const aboutUs = {
  ...
  whatWeOffer: {
    ...
    paragraph: "Through our nearly 30-year history, we have helped thousands of students become professional pilots. In every corner of the globe, and every niche of the industry, you can find USATS graduates.",
    bullets: [
        {
